...
import { n as Hls, t as CapLevelController } from "./hls-BZOfR_ve.js";
...
var pt$2 = Object.defineProperty;
var ra$1 = Object.getOwnPropertyDescriptor;
var aa = Object.getOwnPropertyNames;
var ia$1 = Object.getPrototypeOf, na$1 = Object.prototype.hasOwnProperty;
...
var oa$1 = function(r, e, t, i) {
	if (e && typeof e == "object" || typeof e == "function") for (var a = aa(e), n = 0, o = a.length, s; n < o; n++) s = a[n], !na$1.call(r, s) && s !== t && pt$2(r, s, {
		get: function(u) {
			return e[u];
		}.bind(null, s),
		enumerable: !(i = ra$1(e, s)) || i.enumerable
	});
	return r;
};
var G$3 = function(r, e, t) {
	return t = r != null ? ta(ia$1(r)) : {}, oa$1(e || !r || !r.__esModule ? pt$2(t, "default", {
		value: r,
		enumerable: !0
	}) : t, r);
};
...
function W$2(r) {
	return wt$2(r) || Tt$2(r) || Le$2(r) || Et$2();
}
var X$2 = {
	TRACE: 0,
	DEBUG: 1,
...
var Ct$1 = function(r, e) {
	...
	var u = {}, p = function(c) {
		...
		var R = Ct$1(T, t), te = R.requestStart, Ee = R.requestResponseStart, ke = R.requestResponseEnd, V = R.requestResponseHeaders, le = R.requestMediaDuration, Ge = R.requestHostname, Je = R.requestUrl, Qe = R.requestId;
		o("requestcompleted", {
			request_event_type: d,
			request_start: te,
			request_response_start: Ee,
	...
	var D = function(c) {
		...
		var d = c.type, g = c.chunk, T = c.request, E = g || {}, S = E.mediaInfo, L = E.start, A = (S || {}).type, R = Ct$1(T, t), te = R.requestStart, Ee = R.requestResponseStart, ke = R.requestResponseEnd, V = R.requestBytesLoaded, le = R.requestResponseHeaders, Ge = R.requestMediaDuration, Je = R.requestHostname, Qe = R.requestUrl, xe = R.requestId, K = fa$1(A, t), Xr = K.currentLevel, $r = K.renditionWidth, Zr = K.renditionHeight, ea = K.renditionBitrate;
		o("requestcompleted", {
			request_event_type: d,
			request_start: te,
			request_response_start: Ee,
	...
	return N$1(r, [
		{
			...
			value: function(t, i, a) {
				return i._eventEmitterGuid = i._eventEmitterGuid || ++Bt$1, this._listeners = this._listeners || {}, this._listeners[t] = this._listeners[t] || [], a && (i = i.bind(a)), this._listeners[t].push(i), i;
			}
		},
		{
			key: "off",
		...
		},
		{
			...
			value: function(t, i, a) {
				var n = this;
				i._eventEmitterGuid = i._eventEmitterGuid || ++Bt$1;
				var o = function() {
...
var Jt$2 = 300 * 1e3, Qt$2 = function r(e) {
	"use strict";
	if (k$3(this, r), !e.disableRebufferTracking) {
		var t, i = function(n, o) {
			...
			if (t) {
				...
				P$4(e.data, "view_rebuffer_duration", o), t = n.viewer_time, e.data.view_rebuffer_duration > Jt$2 && (e.emit("viewend"), e.send("viewend"), e.mux.log.warn("Ending view after rebuffering for longer than ".concat(Jt$2, "ms, future events will be ignored unless a programchange or videochange occurs.")));
			}
...
var tr$1 = "muxData", Oa$1 = function(r) {
	...
	try {
		Ye$1.set(tr$1, Oa$1(e), { expires: 365 });
	} catch (t) {}
}, ir$1 = function() {
	var e = rr$1();
	return e.mux_viewer_id = e.mux_viewer_id || re$3(), e.msn = e.msn || Math.random(), ar(e), {
		mux_viewer_id: e.mux_viewer_id,
		mux_sample_number: e.msn
	};
}, nr$1 = function() {
	var e = rr$1(), t = O$3.now();
	return e.session_start && (e.sst = e.session_start, delete e.session_start), e.session_id && (e.sid = e.session_id, delete e.session_id), e.session_expires && (e.sex = e.session_expires, delete e.session_expires), (!e.sex || e.sex < t) && (e.sid = re$3(), e.sst = t), e.sex = t + 1500 * 1e3, ar(e), {
		session_id: e.sid,
		session_start: e.sst,
	...
	return Object.keys(r).forEach(function(i) {
		...
		if (r.hasOwnProperty(i) && r[i] !== void 0) {
			...
			s || (q$1.info("Data key word `" + n[0] + "` not expected in " + i), s = o + "_"), n.splice(1).forEach(function(u) {
				u === "url" && (a = !0), or[u] ? s += or[u] : Number.isInteger(Number(u)) ? s += u : (q$1.info("Data key word `" + u + "` not expected in " + i), s += "_" + u + "_");
			}), a ? t[s] = r[i] : e[s] = r[i];
		}
	}), Object.assign(e, t);
}
...
var Di = [
	...
	function t(i, a, n) {
		...
		return o.one("playerready", f), o.longResumeTracker = new Hr(b$3(o)), o.errorTracker = new Wt$2(b$3(o)), new er$1(b$3(o)), o.seekingTracker = new Xt$2(b$3(o)), o.playheadTime = new Gt$2(b$3(o)), o.playbackHeartbeat = new Ft$2(b$3(o)), new Yt$2(b$3(o)), o.watchTimeTracker = new jt$2(b$3(o)), new Vt$2(b$3(o)), new Wr(b$3(o)), o.adTracker = new Zt$2(b$3(o)), new zt$2(b$3(o)), new Qt$2(b$3(o)), new Kt$2(b$3(o)), new Mr(b$3(o)), new Ur(b$3(o)), new Fr(b$3(o)), new Gr(b$3(o)), n.hlsjs && o.addHLSJS(n), n.dashjs && o.addDashJS(n), o.emit("viewinit", n.data), o;
	}
	return N$1(t, [
		{
			key: "emit",
...
Ve$2.prototype.processLine = function(r) {
	var t = Ni(r, r.indexOf(":")), i = t[0], a = t.length === 2 ? ft$1(t[1]) : void 0;
...
var _t$1 = function(r, e) {
	...
	Ii(e[1]) ? (i = {}, i = Object.assign(Li(e[1]), i)) : i = ft$1(e[1]), r[t] = i;
}, Qr = function(r) {
...
var Bi = "mux-embed", Ui = "5.18.0", Fi = "2.1", M$2 = {}, ue$1 = function(e) {
	var t = arguments;
	typeof e == "string" ? ue$1.hasOwnProperty(e) ? Te.default.setTimeout(function() {
		t = Array.prototype.splice.call(t, 1), ue$1[e].apply(null, t);
	}, 0) : q$1.warn("`" + e + "` is an unknown task") : typeof e == "function" ? Te.default.setTimeout(function() {
		e(ue$1);
...
}, Wt$1 = Zl.utils.generateUUID, mn = ({ playbackId: e, customDomain: t = A$2, maxResolution: r, minResolution: n, renditionOrder: o, programStartTime: s, programEndTime: a, assetStartTime: i, assetEndTime: d, playbackToken: u, tokens: { playback: y = u } = {}, extraSourceParams: c = {} } = {}) => {
	if (!e) return;
...
var zt$1 = (e, t) => {
	...
	var d;
	let { envKey: n, disableTracking: o, muxDataSDK: s = Zl, muxDataSDKOptions: a = {} } = e, i = tt(e);
	if (!o && (n || i)) {
...
//# sourceMappingURL=dist-hOatCJ5r.js.map